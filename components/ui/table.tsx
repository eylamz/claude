...
>(({ className, ...props }, ref) => (
  <div className="bg-card dark:bg-card-dark rounded-3xl shadow-container overflow-hidden">
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "px-6 py-3 text-left rtl:text-right text-xs font-medium text-content/60 dark:text-content-dark/60 uppercase",
      className
    )}
    {...props}
  />
