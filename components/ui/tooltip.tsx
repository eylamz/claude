  ...
  "z-50 overflow-hidden rounded-lg border text-xs px-3 py-1.5 whitespace-nowrap font-semibold",
  {
    variants: {
      variant: {
        ...
        yellow: "bg-yellow-bg dark:bg-yellow-bg-dark border border-yellow-border dark:border-yellow-border-dark text-yellow dark:text-yellow-dark",
        teal: "bg-teal-bg dark:bg-teal-bg-dark border border-teal-border dark:border-teal-border-dark text-teal dark:text-teal-dark",
  ...
  "fill-current rounded-sm",
  {
    variants: {
      variant: {
        ...
        yellow: "text-yellow-border dark:text-yellow-border-dark",
        teal: "text-teal-border dark:text-teal-border-dark",
