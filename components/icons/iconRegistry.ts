...
const iconRegistry: Record<string, () => Promise<IconModule>> = {
  ...
  treesBold: () => import('./treesBold.svg'),
  park: () => import('./park.svg'),
  foodBold: () => import('./foodBold.svg'),
  food: () => import('./food.svg'),
  seatBold: () => import('./seatBold.svg'),
  seat: () => import('./seat.svg'),
  money: () => import('./money.svg'),
  moneyBold: () => import('./moneyBold.svg'),
  shadeBold: () => import('./shadeBold.svg'),
  shade: () => import('./shade.svg'),
  skateboard: () => import('./skateboard.svg'),
  stairsBold: () => import('./stairsBold.svg'),
  ...
  accountBold: () => import('./accountBold.svg'),
  admin: () => import('./admin.svg'),
  adminBold: () => import('./adminBold.svg'),
  backpack: () => import('./backpack.svg'),
  backpackBold: () => import('./backpackBold.svg'),
  book: () => import('./book.svg'),
  bookBold: () => import('./bookBold.svg'),
  broomBold: () => import('./broomBold.svg'),
  category: () => import('./category.svg'),
  categoryBold: () => import('./categoryBold.svg'),
  chart: () => import('./chart.svg'),
  chartBold: () => import('./chartBold.svg'),
  clipboard: () => import('./clipboard.svg'),
  clipboardBold: () => import('./clipboardBold.svg'),
  review: () => import('./review.svg'),
  reviewBold: () => import('./reviewBold.svg'),
  cloudy: () => import('./cloudy.svg'),
  cookie: () => import('./cookie.svg'),
  cookieBold: () => import('./cookieBold.svg'),
  drag: () => import('./drag.svg'),
  dragBold: () => import('./dragBold.svg'),
  emptyBackpack: () => import('./emptyBackpack.svg'),
  emptyCart: () => import('./emptyCart.svg'),
  english: () => import('./english.svg'),
  englishBold: () => import('./englishBold.svg'),
  eyeClosed: () => import('./eyeClosed.svg'),
  eyeClosedBold: () => import('./eyeClosedBold.svg'),
  global: () => import('./global.svg'),
  globalBold: () => import('./globalBold.svg'),
  hebrew: () => import('./hebrew.svg'),
  hebrewBold: () => import('./hebrewBold.svg'),
  lightRain: () => import('./lightRain.svg'),
  locationOff: () => import('./locationOff.svg'),
  locationOffBold: () => import('./locationOffBold.svg'),
  logout: () => import('./logout.svg'),
  logoutBold: () => import('./logoutBold.svg'),
  longboard: () => import('./longboard.svg'),
  mapBold: () => import('./mapBold.svg'),
  mapSheet2: () => import('./mapSheet (2).svg'),
  messagesBold: () => import('./messagesBold.svg'),
  objects: () => import('./objects.svg'),
  objectsBold: () => import('./objectsBold.svg'),
  partlyCloudy: () => import('./partlyCloudy.svg'),
  plantBold: () => import('./plantBold.svg'),
  rainy: () => import('./rainy.svg'),
  SearchBold: () => import('./SearchBold.svg'),
  searchClose: () => import('./searchClose.svg'),
  settings: () => import('./settings.svg'),
  settingsBold: () => import('./settingsBold.svg'),
  'shekel-icon': () => import('./shekel-icon.svg'),
  Skateboard: () => import('./Skateboard.svg'),
  skateBold: () => import('./skateBold.svg'),
  snow: () => import('./snow.svg'),
  sparksBold: () => import('./sparksBold.svg'),
  target: () => import('./target.svg'),
  targetBold: () => import('./targetBold.svg'),
  terms: () => import('./terms.svg'),
  termsBold: () => import('./termsBold.svg'),
  thunderstorm: () => import('./thunderstorm.svg'),
  trainers: () => import('./trainers.svg'),
  trainersBold: () => import('./trainersBold.svg'),
  umbrellaBold: () => import('./umbrellaBold.svg'),
