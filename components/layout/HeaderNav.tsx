...
export default function HeaderNav() {
  ...
  // Top 5 most clicked search results (from analytics), cached per locale
  ...
  // Fetch top 5 most clicked search results for "Popular" in search modal; shared 48h cache per locale
  useEffect(() => {
                        ...
                        {popularClicks.map((item) => {
                          ...
                          return (
                            <Link
                              ...
                              className="px-3 py-1.5 text-sm bg-gray-bg/50 dark:bg-gray-bg-dark hover:bg-gray-hover-bg/50 dark:hover:bg-gray-hover-bg-dark border border-border dark:border-border-dark rounded-full transition-colors text-sidebar-text dark:text-sidebar-text-dark"
                            >
                              {label}
                            </Link>
                          );
