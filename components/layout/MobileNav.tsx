        ...
        <div className="flex items-center justify-between h-16 px-4 overflow-visible">
          ...
          <div className="flex items-center">
            <button
              ...
              className="p-2.5 -ms-2 text-header-icon dark:text-header-icon-dark hover:text-brand-text dark:hover:text-brand-dark transition-colors duration-200"
            ...
            <button
              ...
              className="p-2.5 -mb-[0.4rem] text-header-icon dark:text-header-icon-dark hover:text-brand-text dark:hover:text-brand-dark transition-colors duration-200 active:scale-95"
          ...
          {ecommerceEnabled && (
            <Link
              href={`/${locale}/cart`}
              className="relative h-11 p-2.5 -me-2 text-header-icon dark:text-header-icon-dark hover:text-brand-text dark:hover:text-brand-main hover:bg-gray-100 dark:hover:bg-gray-800/50 rounded-xl transition-all duration-200 active:scale-95 group overflow-visible"              
