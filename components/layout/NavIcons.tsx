...
const SEARCH_BOLD_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22"><g><path class="search-hover" fill="currentColor" d="M10.5,20c5.25,0,9.5-4.25,9.5-9.5S15.75,1,10.5,1,1,5.25,1,10.5s4.25,9.5,9.5,9.5Z"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21,21l-2-2"/></g></svg>`;
